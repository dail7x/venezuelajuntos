...
export async function GET() {
  ...
  <pfif:person>
    ...
    <pfif:latest_status>${item.status}</pfif:latest_status>
...
<pfif:pfif xmlns:pfif="http://zesty.ca/pfif/1.4">${persons}
</pfif:pfif>`, {
